...
class DiagramWindow(QMainWindow):
    def __init__(self):
        ...
        self.LC01F.setStyleSheet("color: red; font-size: 20px; font-weight: bold;")
        self.LC01F.adjustSize()

        self.LC02OX = QLabel("12345", label)
        self.LC02OX.move(664,409)
        self.LC02OX.setStyleSheet("color: red; font-size: 20px; font-weight: bold;")
        ...
        self.TC01F.setStyleSheet("color: red; font-size: 20px; font-weight: bold;")
        self.TC01F.adjustSize()

        self.TC02OX = QLabel("12345", label)
        self.TC02OX.move(230,324)
        self.TC02OX.setStyleSheet("color: red; font-size: 20px; font-weight: bold;")
        self.TC02OX.adjustSize()

        self.TC03OX = QLabel("12345", label)
        self.TC03OX.move(934,282)
        self.TC03OX.setStyleSheet("color: red; font-size: 20px; font-weight: bold;")
        self.TC03OX.adjustSize()

        self.TC02F = QLabel("12345", label)
        self.TC02F.move(930,596)
        self.TC02F.setStyleSheet("color: red; font-size: 20px; font-weight: bold;")
        ...
        self.PT01F.setStyleSheet("color: red; font-size: 20px; font-weight: bold;")
        self.PT01F.adjustSize()

        self.PT02F = QLabel("12345", label)
        self.PT02F.move(659,709)
        self.PT02F.setStyleSheet("color: red; font-size: 20px; font-weight: bold;")
        self.PT02F.adjustSize()

        self.PT03F = QLabel("12345", label)
        self.PT03F.move(885,709)
        self.PT03F.setStyleSheet("color: red; font-size: 20px; font-weight: bold;")
        self.PT03F.adjustSize()

        self.PT04F = QLabel("12345", label)
        self.PT04F.move(1183,596)
        self.PT04F.setStyleSheet("color: red; font-size: 20px; font-weight: bold;")
        self.PT04F.adjustSize()

        self.PT05E = QLabel("12345", label)
        self.PT05E.move(1359,509)
        self.PT05E.setStyleSheet("color: red; font-size: 20px; font-weight: bold;")
        self.PT05E.adjustSize()

        self.PT06OX = QLabel("12345", label)
        self.PT06OX.move(1183,282)
        self.PT06OX.setStyleSheet("color: red; font-size: 20px; font-weight: bold;")
        self.PT06OX.adjustSize()

        self.PT07OX = QLabel("12345", label)
        self.PT07OX.move(885,157)
        self.PT07OX.setStyleSheet("color: red; font-size: 20px; font-weight: bold;")
        self.PT07OX.adjustSize()

        self.PT08OX = QLabel("12345", label)
        self.PT08OX.move(657,158)
        self.PT08OX.setStyleSheet("color: red; font-size: 20px; font-weight: bold;")
        self.PT08OX.adjustSize()

        self.PT09OX = QLabel("12345", label)
        self.PT09OX.move(446,324)
        self.PT09OX.setStyleSheet("color: red; font-size: 20px; font-weight: bold;")
